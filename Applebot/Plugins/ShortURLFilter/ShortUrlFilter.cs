...
namespace SpamFilter
{
    ...
    public class ShortURLFilter : Command
    {
        ...
        public override void HandleMessage<T1, T2>(T1 message, T2 platform)
        {
            ...
            if (URLCheck.IsMatch(message.Content))
            {
